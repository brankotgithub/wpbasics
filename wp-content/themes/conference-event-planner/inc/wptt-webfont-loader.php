...
if ( ! class_exists( 'Conference_Event_Planner_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Conference_Event_Planner_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Conference_Event_Planner_WPTT_WebFont_Loader( $url );
